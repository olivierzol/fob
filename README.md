...
Two independent audits of this codebase (findings resolved) plus a regression test suite (`swift test`) are in [`SECURITY_AUDIT_REPORT.md`](SECURITY_AUDIT_REPORT.md).
